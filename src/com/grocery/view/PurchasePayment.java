...
public class PurchasePayment extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanelPaymentMode2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanelPaymentMode2Layout.createSequentialGroup()
                ...
                .addGroup(jPanelPaymentMode2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanelPaymentMode2Layout.createSequentialGroup()
                        .addComponent(cheque, javax.swing.GroupLayout.DEFAULT_SIZE, 369, Short.MAX_VALUE)
                        .addGap(10, 10, 10)
   ...
   try {
    ...
    public void addStock() throws ParseException {
       ...
       // BigDecimal mrp;
        ...
        while (i < tm.getRowCount()) {
            ...
            hsnCode = jTable1.getValueAt(i, 2).toString();
            quantity = new BigDecimal(tm.getValueAt(i, 3).toString());
            total = new BigDecimal(tm.getValueAt(i, 4).toString());
            unitPrice = new BigDecimal(tm.getValueAt(i, 5).toString());
            gstPercent = new BigDecimal(tm.getValueAt(i, 6).toString());
            gstAmount = new BigDecimal(tm.getValueAt(i, 7).toString());
            finalTotal = new BigDecimal(tm.getValueAt(i, 8).toString());
            sellingUnit = new BigDecimal(tm.getValueAt(i, 9).toString());
            remark = tm.getValueAt(i, 10).toString();
            type = tm.getValueAt(i, 10).toString();
            mfg = new Date(tm.getValueAt(i, 11).toString());
            exp = new Date(tm.getValueAt(i, 12).toString());
          //  mrp = new BigDecimal(tm.getValueAt(i ,12).toString());
            
            itemMaster.setGstType(gstType);
            ...
            itemMaster.setSellingPrice(sellingUnit);
            itemMaster.setEfgDate(mfg);
            itemMaster.setExpDate(exp);
           // itemMaster.setMrp(mrp);

            List<ItemMaster> itemList = itemQueryNew.checkItem(itemMaster);
            if (itemList.isEmpty()) {
                itemQueryNew.insertItem(itemMaster);
            } else {
    ...
    private ItemMaster checkItemAndInsert(String itemName, ItemMaster itemMaster) {
        ItemMaster item;
    ...
    void setValues(JDateChooser purchaseDate, String totalAmount, String discountAmount, String finalAmount, TableModel tableData, String vendorName1, String gstType) {
        totalAmount1.setText((totalAmount));
        finalAmount1.setText((finalAmount));
        discount1.setText((discountAmount));
        vanNname.setText((vendorName1));
