 ...
 * @author Admin
 */
public class SalesPageViewNew extends javax.swing.JInternalFrame {
    ...
    public SalesPageViewNew(JDesktopPane jDesktopPane) {
        initComponents();
    ...
    public SalesPageViewNew(JDesktopPane jDesktopPane, SaleMaster saleMaster, CustomerPartialPayment customerPartialPayment, String counter) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Item Name", "HSN Code", "Availability", "Unit Price", "GST %", "Selling Price", "IGST %"
            }
        ) {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Details Id", "Item Id", "Item Name", "HSN Code", "Unit Price", "Quantity", "GST %", "GST Amount", "Selling Price", "Total", "IGST %", "IGST Amount"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        cancel1.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(item, javax.swing.GroupLayout.PREFERRED_SIZE, 225, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(224, 224, 224))
        );
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel8Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(totalGstAmount, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        .addComponent(PaymentDet, javax.swing.GroupLayout.DEFAULT_SIZE, 1157, Short.MAX_VALUE)
                        .addGap(28, 28, 28))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addComponent(jPanel4, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(157, 157, 157)
                                .addComponent(PaymentDet, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addComponent(jPanel7, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(58, 58, 58))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(194, 194, 194)
    ...
    public void loadTable(ItemMaster itemMaster) {
        ...
        for (Object[] object : list) {
            ...
            defaultTableModel.addRow(new Object[]{ia.getItemMaster().getId(), ia.getItemMaster().getName(), ia.getItemMaster().getBarCode(), ia.getAvailability(), ia.getItemMaster().getSellingPrice(), ia.getItemMaster().getGstPercent(), ia.getItemMaster().getFinalSellingPrice(), ia.getItemMaster().getIgstPercent()});
        }
    ...
    private void getSaleDetails(SaleMaster saleMaster) {
        ...
        for (Object[] object : list) {
            ...
            float gstPercentage = Float.valueOf(sd.getGstPercent().toString());
            ...
            defaultTableModel.addRow(new Object[]{sd.getId(), sd.getItemMaster().getId(), sd.getItemMaster().getName(), sd.getItemMaster().getBarCode(), sd.getUnitPrice(), sd.getQuantity(), sd.getGstPercent(), gstAmount, totalSellingPrice, sd.getTotal(), sd.getIgstPercent(), igstAmount});
        }
    ...
    private void getTotal() {
        ...
        while (i < jTable2.getRowCount()) {
            sum = sum + Float.parseFloat(jTable2.getValueAt(i, 9).toString());
            i++;
        }
        ...
        try {
            ...
            try {
                ...
                if (soldQuantity > availability) {
                    ...
                    CustomerDetails customerMaster = new CustomerDetails();
                    Counter counter = new Counter();
                    CounterQuery counterQuery = new CounterQuery();
                    ...
                    if (billId.getText().isEmpty()) {
                        ...
                        saleMaster.setCustomerDetails(customerMaster);
                    ...
                    if (!(saleDetailsList.isEmpty())) {
                        ...
                        saleDetails.setIgstPercent(new BigDecimal(igstPercent));
    ...
    private double getTotalGSTAmount() {
        ...
        sumOfGstAmount = sumOfGstAmount + Float.parseFloat(jTable2.getValueAt(currRow_g, 7).toString());
        currRow_g++;
    ...
    private double getTotalBillAmount() {
        ...
        while (currRow_s < index) {
            sumOfSellingPrice = sumOfSellingPrice + Float.parseFloat(jTable2.getValueAt(currRow_s, 9).toString());
            currRow_s++;
        }
    ...
    private void pay() {
        try {
            ...
            customerPartialPayment.setCustomerDetails(customerMaster);
...
//            }
            ...
            saleMaster.setIgstAmount(BigDecimal.valueOf(getTotalIGSTAmount()));
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                ...
                clear();
                if (gstTaken.isSelected()) {
                    printBill(saleMaster, "GST");
                } else if (igstTaken.isSelected()) {
                    printBill(saleMaster, "IGST");
                } else {
                    printBill(saleMaster, "NON-GST");
                }
...
//            }
            if (gstTaken.isSelected()) {
                ...
                saleMaster.setGstAmount(BigDecimal.valueOf(Double.valueOf(totalGstAmount.getText().trim())));
                saleMaster.setIgstAmount(BigDecimal.valueOf(0.00));
            } else if (igstTaken.isSelected()) {
                saleMaster.setGstAmount(BigDecimal.valueOf(0.00));
                saleMaster.setIgstAmount(BigDecimal.valueOf(Double.valueOf(totalGstAmount.getText().trim())));
            ...
            saleMaster.setBillAmount(new BigDecimal(getTotalBillAmount()));
            saleMaster.setFinalBillAmount(BigDecimal.valueOf(getTotalBillAmount() + getTotalGSTAmount() + getTotalIGSTAmount()));
            saleMaster.setDiscount(new BigDecimal(0));
...
//                gstTaken.setSelected(true);
    ...
    private void changeQuantity() {
        try {
            ...
            int detailsId = Integer.parseInt(jTable2.getValueAt(jTable2.getSelectedRow(), 0).toString());
            int itemId = Integer.parseInt(jTable2.getValueAt(jTable2.getSelectedRow(), 1).toString());
            float quantity = Float.parseFloat(jTable2.getValueAt(jTable2.getSelectedRow(), 5).toString());
            float unitPrice = Float.parseFloat(jTable2.getValueAt(jTable2.getSelectedRow(), 4).toString());
            float sellingPrice = Float.parseFloat(jTable2.getValueAt(jTable2.getSelectedRow(), 8).toString());
            float gstPercent = Float.parseFloat(jTable2.getValueAt(jTable2.getSelectedRow(), 6).toString());
