    ...
    private void loadtable() 
    {
        ...
        if(flag)
        {
            ...
            for(Object[] object: list)
            {
                ...
                defaultTableModel.addRow(new Object[]{sd.getItemMaster().getName(), sd.getItemMaster().getBarCode(), sd.getQuantity(), sd.getUnitPrice(), sd.getGstPercent(), sd.getGstAmount(), sd.getFinalTotal()});
