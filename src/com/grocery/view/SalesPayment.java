    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(finalAmount1, javax.swing.GroupLayout.DEFAULT_SIZE, 165, Short.MAX_VALUE)
                .addContainerGap())
        );
...
//        amount.setText(finalAmount);
  ...
  public void setValues(JDateChooser saleDate, String totalAmount, TableModel tableData, String custName, String barCodeType) {
        
        totalAmount1.setText((totalAmount));
        vanNname.setText((custName));
        this.jTable1 = tableData;
        venName = custName;
    ...
    public void addStock() throws ParseException {
       ...
       // BigDecimal mrp;
        ...
        vendorBillMaster.setRemark(barCodeType);
        ...
        while (i < tm.getRowCount()) {
          ...
          //  mrp = new BigDecimal(tm.getValueAt(i ,12).toString());
            ...
            itemMaster.setBarCode(barCodeType);
            itemMaster.setName(itemName);
            itemMaster.setBarCode(brandName);
 ...
 //           stockDetails.setPurchaseMaster(itemMaster);
            stockDetails.setQuantity(quantity);
 //           stockDetails.setActualAmount(total);
