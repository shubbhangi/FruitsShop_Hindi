...
public class ItemAvailabilityView extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "वस्तु का नाम", "ब्रांड", "बारकोड", "उपलब्ध मात्रा", "जीएसटी %", "यूनिट मूल्य", "निर्माण तिथि", "समाप्ति तिथि"
            }
        ) {
        ...
        public void loadTable(ItemMaster itemMaster)
    {
        ...
        list = itemAvailabilityQuery.getAvailability1(itemAvailability);
        
        for(Object[] object: list)
        {
            ItemAvailability ia = (ItemAvailability)object[0];

            defaultTableModel.addRow(new Object[]{ia.getItemMaster().getName(),ia.getItemMaster().getBrand(),ia.getItemMaster().getBarCode(),ia.getAvailability(),ia.getItemMaster().getGstPercent(),ia.getItemMaster().getSellingPrice() ,ia.getItemMaster().getEfgDate(),ia.getItemMaster().getExpDate()});
        }
