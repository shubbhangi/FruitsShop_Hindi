    ...
    private void loadTable() 
    {
        ...
        if(flag)
        {
            ...
            for(Object[] object: list)
            {
                ...
                defaultTableModel.addRow(new Object[]{sd.getId(), sd.getPurchaseMaster().getId(), sd.getPurchaseMaster().getName(), sd.getActualAmount(), sd.getQuantity(), sd.getGstPercent(), sd.getGstAmount(), sd.getFinalTotal(), ia.getAvailability(),ia.getItemMaster().getEfgDate(),ia.getItemMaster().getExpDate()});
