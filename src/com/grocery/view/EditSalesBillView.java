...
public class EditSalesBillView extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel33.setText("Warehouse Name:");

        warehouseName.setEditable(false);
        warehouseName.setBackground(new java.awt.Color(255, 255, 153));
        warehouseName.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        warehouseName.setForeground(new java.awt.Color(255, 0, 0));
        warehouseName.setHorizontalAlignment(javax.swing.JTextField.CENTER);
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(warehouseName, javax.swing.GroupLayout.PREFERRED_SIZE, 245, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(46, 46, 46)
    ...
    private void getSaleDetails(SaleMaster saleMaster) 
    {
        ...
        for(Object[] object: list)
        {
            ...
            defaultTableModel.addRow(new Object[]{sd.getId(), sd.getItemMaster().getId(), sd.getItemMaster().getName(), sd.getItemMaster().getBarCode(), sd.getUnitPrice(), sd.getGstPercent(), sd.getSellingPrice(), sd.getQuantity(), sd.getTotal()});
        }
    ...
    private void loadTable(SaleMaster saleMaster) 
    {
        ...
        for(Object[] object: list)
        {
            ...
            warehouseName.setText(sd.getSaleMaster().getCustomerDetails().getName());
    ...
    public void loadTable(ItemMaster itemMaster)
    {
        ...
        for(Object[] object: list)
        {
            ...
            defaultTableModel.addRow(new Object[]{ia.getItemMaster().getId(), ia.getItemMaster().getName(), ia.getItemMaster().getBarCode(), ia.getAvailability(), ia.getItemMaster().getSellingPrice(), ia.getItemMaster().getGstPercent(), ia.getItemMaster().getFinalSellingPrice()});
        }
    ...
    private void save() 
    {
        ...
        if(confirm == JOptionPane.YES_OPTION)
        {
           ...
           // CustomerDetails customerDetails = new CustomerDetails();
            customerDetails.setName(warehouseName.getText());
            ...
            if(Float.parseFloat(this.billAmount.getText()) > Float.parseFloat(this.total.getText()))
            {
                ...
                if(Float.parseFloat(this.paidAmount.getText()) ==  0)
                       customerDetails.setBalance(customerDetails.getBalance().subtract((billAmount.subtract(total))));
                else
                {
                    customerDetails.setBalance(customerDetails.getBalance().subtract((billAmount.subtract(total))).add(paidAmount));
                    ...
                    expenses.setRemark("Amount paid to customer: " + customerDetails.getName());
                ...
                {
                    if(Float.parseFloat(this.paidAmount.getText()) ==  0)
                        customerDetails.setBalance(customerDetails.getBalance().add((total.subtract(billAmount))));
                    else
                        customerDetails.setBalance(customerDetails.getBalance().add((total.subtract(billAmount))).subtract(paidAmount));
