...
{
    public void insertIntoCustomerPartialPaymentView(CustomerPartialPayment customerPartialPayment)
     {
    ...
    public List<Object[]> getCustomerPaymentHistory(CustomerPartialPayment customerPartialPayment)
    {
        ...
        String query = "FROM CustomerPartialPayment cpp JOIN cpp.customerMaster cm "
                +      "WHERE cpp.customerMaster = " + customerPartialPayment.getCustomerDetails().getId();
