    ...
    private void loadTable() 
    {
        try
        {
            ...
            for(Object[] object: list)
            {
                ...
                defaultTableModel.addRow(new Object[]{sd.getId(), sd.getItemMaster().getId(), sd.getItemMaster().getName(), sd.getItemMaster().getHsnCode(), sd.getUnitPrice(), sd.getQuantity(), sd.getGstPercent(), sd.getTotal()});
    ...
    private void save() 
    {
        ...
        if(confirm == JOptionPane.YES_OPTION)
        {
            ...
            for(Object[] object: list)
            {
                ...
                customerMaster.setId(sd.getSaleMaster().getCustomerMaster().getId());
                customerMaster.setBalance(sd.getSaleMaster().getCustomerMaster().getBalance().subtract(new BigDecimal(total.getText())));
            }
            ...
            else
            {
                ...
                expenses.setRemark("Amount Paid to customer with bill Id: " + billId);
