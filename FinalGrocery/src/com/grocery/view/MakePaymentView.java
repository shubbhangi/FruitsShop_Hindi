...
public class MakePaymentView extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addComponent(vendorAccounts1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            .addComponent(jSeparator3)
            .addComponent(vendorAccounts2, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    {   
        ...
        else
        {
            ...
            if(confirm == JOptionPane.YES_OPTION)
            {
                ...
                if(!(paymentMode.equalsIgnoreCase("cheque")))
                {
                    customerMaster.setBalance(customerMaster.getBalance().subtract(new BigDecimal(paidAmount.getText().trim())));
