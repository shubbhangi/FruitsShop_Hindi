...
public class BillDetailsView extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabelChallan.setFont(new java.awt.Font("Georgia", 1, 10)); // NOI18N
        jLabelChallan.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabelChallan.setText("Challan #:");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item Name", "HSN Code", "Quantity", "Unit Price", "GST %", "GST Amount", "Total"
            }
        ) {
        ...
        jLabelChallan1.setFont(new java.awt.Font("Georgia", 1, 10)); // NOI18N
        jLabelChallan1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabelChallan1.setText("Bill Amount:");
        ...
        jLabelChallan2.setFont(new java.awt.Font("Georgia", 1, 10)); // NOI18N
        jLabelChallan2.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabelChallan2.setText("Discount:");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jLabelChallan3)
                            .addComponent(jLabelChallan2)
                            .addComponent(jLabelChallan1))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void loadtable() 
    {
        ...
        if(flag)
        {
            ...
            for(Object[] object: list)
            {
                ...
                defaultTableModel.addRow(new Object[]{sd.getItemMaster().getName(), sd.getItemMaster().getHsnCode(), sd.getQuantity(), sd.getUnitPrice(), sd.getGstPercent(), sd.getGstAmount(), sd.getFinalTotal()});
        ...
        else
        {
            ...
            for(Object[] object: list)
            {
                ...
                defaultTableModel.addRow(new Object[]{sd.getItemMaster().getName(), sd.getItemMaster().getHsnCode(), sd.getQuantity(), sd.getUnitPrice(), sd.getGstPercent(), "", sd.getTotal()});
                
                name.setText(sd.getSaleMaster().getCustomerMaster().getName());
