...
public class StoreDetails  implements java.io.Serializable {
    ...
    public StoreDetails(String name, String address, String city, String state, String pincode, String phone, String website, String email, String gstNumber, String hsnCode, byte[] photo, Set vendorBillMasters, Set saleMasters) {
       this.name = name;
