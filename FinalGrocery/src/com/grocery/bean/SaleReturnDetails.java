...
public class SaleReturnDetails  implements java.io.Serializable {
    ...
    public SaleReturnDetails(ItemMaster itemMaster, SaleReturn saleReturn, BigDecimal quantity, BigDecimal unitPrice, BigDecimal gstPercent, BigDecimal gstAmount, BigDecimal finalTotal) {
