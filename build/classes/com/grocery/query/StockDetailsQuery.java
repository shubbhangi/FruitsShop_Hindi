...
{
    public void insertIntoStockDetails(StockDetailsPurchase stockDetailsPurchase)
    {
       Session session = HibernateUtil.getSessionFactory().openSession();
        ...
        try
        {
            ...
            session.save(stockDetailsPurchase);
            transaction.commit();
        }
        catch(Exception e)
        {
    ...
    public List<Object[]> getPurchaseDetails(StockDetailsPurchase stockDetails)
    {
    ...
    public List<Object[]> getPurchase(StockDetailsPurchase stockDetails)
    {
        String query = "FROM StockDetails sd JOIN sd.vendorBillMaster vbm JOIN sd.itemMaster im "
    ...
    public void updateStockDetails(StockDetailsPurchase stockDetails)
    {
        Session session = HibernateUtil.getSessionFactory().openSession();
        ...
        {
            Transaction transaction = session.beginTransaction();
            StockDetailsPurchase sd = (StockDetailsPurchase)session.load(StockDetailsPurchase.class, stockDetails.getId());
