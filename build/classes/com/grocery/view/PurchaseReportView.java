...
public class PurchaseReportView extends javax.swing.JInternalFrame {
 ...
 joinQuery = "SELECT\n" +
	...
	"	stock_details_purchase.`gstAmount` AS stock_details_purchase_gstAmount,\n" +
	"	stock_details_purchase.`gstPercent` AS stock_details_purchase_gstPercent,\n" +
   
	"	(stock_details_purchase.`gstAmount`/2) AS stock_details_purchase_cgst,\n" +
	"	(stock_details_purchase.`gstAmount`/2) AS stock_details_purchase_sgst,\n" +
	"	stock_details_purchase.`billId` \n" +
	"	FROM \n" +
	...
	"	INNER JOIN stock_details_purchase stock_details_purchase ON stock_details_purchase.`billId` = vendor_bill_master.id \n" +
...
//                            "   group BY vendor_bill_master.id ASC";
                ...
                reportSource = ReadFile.getPath() + "PurchaseReportGst.jrxml"; 
            ...
            joinQuery = "SELECT\n" +
                ...
                "     store_details.`photo` AS store_details_photo,\n" +
                "	stock_details_purchase.`gstAmount` AS stock_details_purchase_gstAmount,\n" +
                "	stock_details_purchase.`igstAmount` AS stock_details_purchaseigstAmount,\n" +
                "	stock_details_purchase.`gstPercent` AS stock_details_purchase_gstPercent,\n" +
                "	stock_details_purchase.`igstPercent` AS stock_details_purchase_igstPercent,\n" +
                "	(stock_details_purchase.`gstAmount`/2) AS stock_details_purchase_cgst,\n" +
                "	(stock_details_purchase.`gstAmount`/2) AS stock_details_purchase_sgst\n" +
                "FROM\n" +
                "  `vendor_bill_master` vendor_bill_master \n" +
...
//                            "     SUM(vendor_bill_master.`finalBillAmount`) AS finalBillAmount,\n" +
        ...
        joinQuery = "SELECT \n"
                ...
                reportSource = ReadFile.getPath() + "PurchaseReportNonGst.jrxml"; 
        }
