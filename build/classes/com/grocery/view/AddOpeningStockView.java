...
public class AddOpeningStockView extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item Name", "HSN Code", "Quantity", "Unit Price", "Selling Price", "Selling GST %", "GST Amount", "IGST %", "IGST Amount", "Final Selling Price"
            }
        ) {
        ...
        nonGst.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        ...
        igstTaken.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        ...
        gstTaken.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(hsnCode, javax.swing.GroupLayout.PREFERRED_SIZE, 106, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
...
//                        itemMaster.setSellingPrice(new BigDecimal(String.valueOf(cellList.get(4))));
...
//                        itemMaster.setFinalSellingPrice(new BigDecimal(String.valueOf(cellList.get(6))));
                        ...
                        itemMaster.setName(String.valueOf(cellList.get(0)));
                        itemMaster.setBarCode(String.valueOf(cellList.get(1)));
                        itemMaster.setUnitPrice(new BigDecimal(String.valueOf(cellList.get(2))));
                        itemMaster.setGstPercent(new BigDecimal(String.valueOf(cellList.get(3))));
                        itemMaster.setSellingPrice(new BigDecimal(String.valueOf(cellList.get(4))));
                        itemMaster.setSellingGstPercent(new BigDecimal(String.valueOf(cellList.get(5))));
                      
                        itemMaster.setGstType(String.valueOf(cellList.get(6)));
 //                      itemMaster.setIgstPercent(new BigDecimal(String.valueOf(cellList.get(7))));
                       // itemMaster.setFinalSellingPrice(new BigDecimal(String.valueOf(cellList.get(6))));
  ...
  //                      itemAvailability.setAvailability(new BigDecimal(String.valueOf(cellList.get(7))));
            ...
            if (jTable1.getRowCount() != 0) {
               ...
               //     float gstPercent = Float.parseFloat(jTable1.getValueAt(i, 4).toString());
                    float sellingPrice = Float.parseFloat(jTable1.getValueAt(i, 4).toString());
                    float sellingGstPercent = Float.parseFloat(jTable1.getValueAt(i, 5).toString());
                    float gstAmount = Float.parseFloat(jTable1.getValueAt(i, 6).toString());
                   
                    float iGstPercent = Float.parseFloat(jTable1.getValueAt(i, 7).toString());
                    float igstAmount = Float.parseFloat(jTable1.getValueAt(i, 8).toString());
                    
                    float finalSellingPrice = Float.parseFloat(jTable1.getValueAt(i, 9).toString());

                    itemMaster.setName(itemName);
                    itemMaster.setBarCode(hsnCode);
                    itemMaster.setUnitPrice(new BigDecimal(unitPrice));
                    itemMaster.setGstPercent(new BigDecimal(sellingGstPercent));
                    ...
                    itemMaster.setFinalSellingPrice(new BigDecimal(finalSellingPrice));
                     ...
                     itemMaster.setIgstPercent(new BigDecimal(iGstPercent));
                     if(!(iGstPercent<=0)){
                        itemMaster.setGstType("IGST");
                    }else if(!(sellingGstPercent<=0)){
                        itemMaster.setGstType("GST");
                    }else{
                        itemMaster.setGstType("NON-GST");
                    }
    ...
    private void addToTable() {
        ...
        defaultTableModel.addRow(new Object[]{itemName, hsnCode, quantity, decimalFormat.format(unitPrice), decimalFormat.format(sellingPrice), decimalFormat.format(sellingGstPercent), decimalFormat.format(sellingGstAmount), decimalFormat.format(igstPercent),decimalFormat.format(sellingIGstAmount),decimalFormat.format(finalSellingPrice)});
